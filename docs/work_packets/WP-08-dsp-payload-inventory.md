...
- Next action: Submit the focused changes as a draft PR and keep it in review until maintainer review and G1 architecture evidence are complete.
- Waiting on: Maintainer review; G1 hardware-realizable architecture remains open in WP-06–10.
- Blockers: none known for this packet's deliverables.
...
- Remaining:
  - [ ] Receive review and reconcile the accepted delivery; G1 architecture feasibility remains outside this packet's evidence.
...
- Blockers: none known.
- Next action: Commit and push this scoped packet, create its draft PR, then continue the next ready G1 packet while review remains pending.
- Delivery: this prompt's enclosing commit on `work/wp-08-dsp-payload-inventory`; draft PR URL to be recorded after creation.
