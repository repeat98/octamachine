...
- [x] Profile four assignment/eight-hit scenarios and six trigger/encoder scenarios across five core engine families with aggregate ColdFire and descriptor-handler-range counts; raw outputs remain private.
