...
| --- | --- | --- | --- |
| MD UW OS 1.63 image identity | measured | Local ignored image matches the 8 MiB size, MAME CRC/SHA-1, and Gearmulator FNV-64; [audit](BOOT_FEASIBILITY.md#local-image-audit--2026-09-23). | [WP-02](work_packets/WP-02-target-profiles.md) |
