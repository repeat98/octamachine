...
| Reset vectors and bootstrap bytes | measured | Static and Gearmulator reset checkpoints show PC `0x0000000c`, initial SP zero, and subsequent runtime progress; stack establishment after reset remains untraced. | [WP-04](work_packets/WP-04-machinedrum-baseline.md), [WP-12](work_packets/WP-12-target-bootstrap.md) |
