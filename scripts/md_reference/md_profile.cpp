...
// patches/gearmulator-md-mm/md-reference/gearmulator-md-exechook.patch) against the user's own OS 1.63
...
int main(int _argc, char** _argv)
{
	...
	// The wait loops (measured 23 Sep 2026, docs/reports/WP-35-octamad-md-import.md,
	// "DSP load in the reference"): the producer's nop delay (P:100092..100098) and its port-C
